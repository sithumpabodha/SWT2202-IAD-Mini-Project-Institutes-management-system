...
<html lang="en">
  <head>
    ...
    <title>Dip Edu|| Student Forgot Password</title>
    <!-- plugins:css -->
            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                <div class="brand-logo">
                 <img src="images/logo.png"> Dip Educations
                </div>
                ...
                <form class="pt-3" id="login" method="post" name="login">
                  ...
                  <div class="my-2 d-flex justify-content-between align-items-center">
                    ...
                    <a href="login.php" class="btn btn-block btn-facebook auth-form-btn">Sign in</a>
                  </div>
                  <div class="mb-2">
                    <a href="../index.php" class="btn btn-block btn-twitter auth-form-btn">
